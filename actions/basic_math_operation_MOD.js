...
subtitle: function(data) {
	const info = ['Dodanie', 'Odejmowanie', 'Mnożenie', 'Podzial'];
...
short_description: "Wykonuj podstawowe operacje matematyczne",
...
fields: ["PierwszyNumer", "info", "DrugiNumer", "przechowywanie", "varNazwa"],
